...
`cursor-acp-bridge` spawns **cursor-agent** in your workspace and **auto-approves file
...
please open a [GitHub Security Advisory](https://github.com/andreilungeanu/cursor-acp-bridge/security/advisories/new)
