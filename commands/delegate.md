---
description: Delegate to Cursor, Composer, or cursor-agent via cursor-acp-bridge (see delegate skill)
argument-hint: <task description>
---

Follow the **delegate** skill (`/cursor-acp-bridge:delegate` or auto-invoked) for the full
